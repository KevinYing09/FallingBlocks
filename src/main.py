...
def draw_window(surface, grid):
    ...
    label = font.render('Falling Blocks', 1, (255, 255, 255))
...
def main(win):
    ...
    while run:
        ...
        if check_lost(locked_positions):
            draw_text(win, "YOU LOST!", play_width/2, play_height/2, 80, (255,255,255))
            pygame.display.update()
...
def main_menu(win):
    ...
    while run:
        win.fill((0,0,0))
        draw_text(win, 'Welcome to Falling Blocks',top_left_x + play_width/2, top_left_y + play_height/3, 60, (255,255,255))
